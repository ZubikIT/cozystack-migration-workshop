...
`namespace: tenant-workshop80` — ваш участок платформы. В файле на виртуалке здесь **уже
стоит ваш номер** — его подставили при подготовке стенда, менять ничего не нужно.
Namespace («пространство имён») — это перегородка внутри кластера: объекты с
одинаковыми именами в разных namespace друг другу не мешают и друг друга не видят.
Ближайший аналог — отдельный Resource Pool со своими правами доступа, только строже.
