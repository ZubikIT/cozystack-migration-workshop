...
⚠️ **Номер тенанта в манифестах уже подставлен** — при подготовке виртуалки везде
проставлен ваш `tenant-workshop80`. Вписывать вручную ничего не нужно. Единственное,
