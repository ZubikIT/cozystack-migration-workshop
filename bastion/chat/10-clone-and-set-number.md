...
уже подставлен** при подготовке виртуалки — искать и заменять ничего не надо, сразу
применяйте файлы как есть.
...
В строке `namespace:` будет ваш `tenant-workshop80`, а не заглушка.
