...
Оба берутся в дашборде. Тенантный лежит в секрете `kubeconfig-tenant-workshop80`
...
происходит: `kubectl -n tenant-workshop80 get pods | grep harbor`. Чаще всего это очередь
...
#   -n tenant-workshop80  в каком пространстве имён искать — в вашем тенанте
...
kubectl -n tenant-workshop80 get secret harbor-harbor-credentials \
