...
раскрывается **внутри пода**, из переменной пода. Ваш виртуалку этих значений не видит и в
...
внутри сервера. Данные не ходили по сети, не проходили через ваш виртуалку и не лежали в
