...
ниже прокинет туннель с виртуалки внутрь.

```bash
# port-forward = туннель с виртуалки внутрь кластера, живёт, пока команда работает.
#   svc/rickroll   вести туннель к Service с именем rickroll, а тот уже направит
#                  запрос на живую копию приложения
#   8080:80        левое число — порт на виртуалке, правое — порт Service в кластере
