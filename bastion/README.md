...
и ваш номер тенанта в манифестах и скриптах **уже подставлен** при подготовке
виртуалки — везде стоит `tenant-workshop80`. Ничего искать и заменять не нужно —
сразу применяйте файлы как есть.
