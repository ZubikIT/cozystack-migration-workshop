...
хранилищем, а на ноутбук ставить её не придётся. Подставьте свой номер тенанта:
...
⚠️ **Скопируйте оба значения в файл на ноутбуке прямо сейчас** — например в
...
- **корневой токен** — в конце лабы, для скрипта проверки. Между этими моментами пройдёт
  час, и терминал вы к тому времени, скорее всего, закроете.
...
Срок жизни здесь не формальность. Ушёл токен в лог, попал в бэкап, утёк с ноутбуком —
